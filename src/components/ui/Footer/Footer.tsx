        ...
        <div className="footer__content">
          ...
          <div className="footer__fees">
            <div className="footer__fees-content">
              <a href="/tarifas" className="footer__h3">
                Tarifas y Títulos
              </a>
              <a href="/tarjetas" className="footer__p">
                Tarjetas
              </a>
          ...
          <div className="footer__attention">
            <div className="footer__attention-content">
              ...
              <a className="footer__p">
                Estación de metro-colón
                <br />
                L-V de 9:00 a 19:00
              </a>
              <a className="footer__p">
                La atencion presencial requiere cita previa
                <br />
